...
const events = [
  {
    title: "Ohill Birding",
    date: "Friday Nov 11, 2025",
    time: "7:00am - 9:15am",
    location: "Meeting at Slaughter",
    image: "/images/local-trips/ohill.png", // Use home page image
    url: "/events/ohill-birding-2025-11-11", // Unique URL with date
    dateISO: "2025-11-11", // ISO for logic
  }
]
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground mb-4">
                        Have an idea for a trip or event? Reach out to us!
                      </p>
                      <Link href="mailto:birdingatuva@gmail.com" className="block w-full">
                        <span className="inline-block bg-primary text-primary-foreground px-4 py-2 rounded-lg text-center">Contact Us</span>
                      </Link>
                    </CardContent>
                  </Card>
                </div>
                    ...
                    >
                      <Link href={event.url} className="block relative h-48 overflow-hidden p-0 m-0">
                        <Image
                          ...
                          alt={event.title}
                          fill
                          className={`object-cover group-hover:scale-110 transition-transform duration-500${status === "Past" ? " grayscale brightness-90" : ""}`}
                          quality={85}
                        ...
                        <Badge
                          ...
                          style={{ backgroundColor: status === "Past" ? '#888' : status === "Current" ? '#2563eb' : '#36834C', color: 'white' }}
                        >
                          {status}
                        </Badge>
                      </Link>
